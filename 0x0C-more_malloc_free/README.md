1. C - More malloc, free Tasks 0. Trust no one Write a function that allocates memory using malloc.
...
4_realloc Write a function that reallocates a memory block using malloc and free
